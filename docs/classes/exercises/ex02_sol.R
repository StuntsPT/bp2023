## Possible solutions for class 02 exercises (https://stuntspt.gitlab.io/bp2023/classes/exercises/ex02.html)
...
#Use online data:
diatoms_data = read.csv("https://gitlab.com/StuntsPT/bp2023/raw/master/docs/classes/C05_assets/Dados_diatoms_heavymetals.csv", row.names=2)
