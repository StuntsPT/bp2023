...
Get the [Pokemon data](https://gitlab.com/StuntsPT/bp2023/raw/master/docs/classes/exercises/poke_data.csv) again ([Alternate link](https://raw.githubusercontent.com/StuntsPT/BP2022/master/docs/classes/exercises/poke_data.csv)).
